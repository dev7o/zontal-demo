...
<body class="dark:bg-[#121317]">
    ...
    <div class="flex items-center px-4 h-[70vh]">
        <?php // Form Start ?>
        <form onsubmit="return verifyPassword()" id="signup_form" action="<?php echo $site_url ?>includes/functions.php"
            method="post" class="login-form mx-auto my-12 w-96">
            ...
            if (isset($_GET['s_msg'])) { ?>
                ...
                <?php // Showing Errors ?>
                <div class="alert text-center py-3 mb-6 font-bold rounded-lg bg-green-300 w-full">
                    <?php Secure_Field($_GET['s_msg']); ?></div>
                <?php session_unset();
            } ?>
            ...
            <div class="input-group flex flex-direction-column mb-6">
                ...
                <input value="<?php if (isset($_SESSION['name'])) {
                    ...
                    class="border-2 dark:text-gray-300 dark:border-zinc-700 dark:bg-zinc-800 transition duration-300 border-gray-200 px-2 py-3 outline-none rounded-lg focus:border-blue-700 "
            ...
            <div class="input-group flex flex-direction-column mb-6">
                ...
                <input value="<?php if (isset($_SESSION['email'])) {
                    ...
                    class="border-2 dark:text-gray-300 dark:border-zinc-700 dark:bg-zinc-800 transition duration-300 <?php if (isset($_GET['email_msg'])) {
                        echo "border-red-500 focus:outline-red-500";
                    } else {
                        echo "focus:border-blue-700 border-gray-200";
                    } ?>  px-2 py-3 outline-none rounded-lg  "
                    type="email" placeholder="Email">

                <?php // Show Email Validating Error ?>
                <?php if (isset($_GET['email_msg'])) { ?>
                    <label class="select-none text-red-800 text-xs mb-1 mt-1"> <?php Secure_Field($_GET['email_msg']); ?>
                    </label>
                <?php } ?>
            ...
            <div class="input-group flex flex-direction-column mb-6">
                ...
                <input value="<?php if (isset($_SESSION['username'])) {
                    ...
                    class="border-2 dark:text-gray-300 dark:border-zinc-700 dark:bg-zinc-800 transition duration-300 <?php if (isset($_GET['username_msg'])) {
                        echo "border-red-500 focus:outline-red-500";
                    } else {
                        echo "focus:border-blue-700 border-gray-200";
                    } ?> px-2 py-3 outline-none rounded-lg "
                ...
                <?php if (isset($_GET['username_msg'])) { ?>
                    <label class="select-none text-red-800 text-xs mb-1 mt-1"> <?php Secure_Field($_GET['username_msg']); ?>
                    </label>
                <?php } ?>
            </div>
            ...
            <div class="input-group flex flex-direction-column">
                ...
                <input id="R_password" name="password" required
                    class="border-2 transition duration-300 dark:text-gray-300 dark:border-zinc-700 dark:bg-zinc-800 border-gray-200 px-2 py-3 outline-none rounded-lg focus:border-blue-700 "
            ...
            <div id="input-group" class="input-group hidden flex mt-4 flex-direction-column">
                ...
                <input id="input-tag" disabled name="password" required
                    class="border-2 transition duration-300 dark:text-gray-300 dark:border-zinc-700 dark:bg-zinc-800 border-gray-200 px-2 py-3 outline-none rounded-lg focus:border-blue-700 "
                    type="text" placeholder="Your Password">
            </div>
            <?php // Submit Button ?>
            <button id="sign_up_button" name="signup" type="submit"
                class="w-full text-sm h-12 bg-blue-500 mt-4 text-white uppercase font-bold space-lg rounded-lg">Sign
                up</button>
