...
<body class="bg-dark dark:bg-zinc-900">
    ...
    <div class="body container-zon mt-2 px-0">
        <h1 class="font-bold dark:text-gray-200 text-4xl mb-3 mt-12 text-center capitalize">Result Found (<?php echo Exist_Data("zap_games", "game_name like '%$query%'") ?>) From: <?php echo $query ?></h1>
