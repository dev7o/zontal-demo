...
<body class="dark:bg-[#121317]">
    ...
    <div class="flex items-center px-4 h-[80vh]">
        <?php // Form Start ?>
        <form class="login-form mx-auto my-12 w-96" action="<?php echo $site_url ?>includes/functions.php"
            method="post">
            ...
            <div class="input-group flex flex-direction-column mb-6">
                <label class="select-none uppercase text-gray-500 text-xs mb-1 dark:text-gray-300">Username /
                    Email</label>
                <input required name="username_email"
                    class="border-2 transition dark:text-gray-300 dark:border-zinc-700 dark:bg-zinc-800 duration-300 border-gray-200 px-2 py-4 outline-none rounded-lg focus:border-blue-700 "
                    type="text"
                    value="<?php if (isset($_SESSION['Loggedin_user'])) {
            ...
            <div class="input-group flex flex-direction-column">
                ...
                <input name="password" required
                    class="border-2 transition dark:text-gray-300 duration-300 dark:border-zinc-700 dark:bg-zinc-800 border-gray-200 px-2 py-4 outline-none rounded-lg focus:border-blue-700 "
                    type="password" placeholder="Password">
            </div>
            <?php // Submit Button ?>
            <button type="submit" name="login"
                class="w-full text-sm h-12 bg-blue-500 mt-4 text-white uppercase font-bold space-lg rounded-lg">Login</button>
